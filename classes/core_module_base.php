...
abstract class Core_Module_Base
{
    ...
    //
    // Usage: $host->add_permission_field($this, 'manage_cms', 'Manage CMS')->renderAs(frm_checkbox)->comment('Description');
    //
    ...
    //
    // Usage: $host->add_preference_field($this, 'allow_emails', 'Allow Emails', true)->renderAs(frm_checkbox)->comment('Description');
    //
